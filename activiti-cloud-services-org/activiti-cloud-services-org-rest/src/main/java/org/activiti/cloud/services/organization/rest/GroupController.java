...
package org.activiti.cloud.services.organization.rest;
...
/**
 * Controller for group resources
 */
@RestController
@RequestMapping(
        value = "/v1/groups",
...
public class GroupController {
    ...
    public PagedResources<GroupResource> getTopLevelGroups(Pageable pageable) {
    ...
    public PagedResources<GroupResource> getSubgroups(@PathVariable String groupId,
                                                      Pageable pageable) {
        return pagedResourcesAssembler.toResource(pageable,
    ...
    @RequestMapping(method = PUT, path = "/{groupId}/subgroups", consumes = TEXT_URI_LIST_VALUE)
    ...
    public Resource<Group> getGroup(@PathVariable String groupId) {
        return resourceAssembler.toResource(findById(groupId));
    }
    ...
    public Resource<Group> createSubgroup(@PathVariable String groupId,
        ...
        group.setParent(findById(groupId));
        return resourceAssembler.toResource(groupRepository.createGroup(group));
    }
    ...
    public Resource<Group> updateGroup(@PathVariable String groupId,
                                       @RequestBody Group group) {
        Group groupToUpdate = findById(groupId);
    ...
    public void deleteGroup(@PathVariable String groupId) {
        groupRepository.deleteGroup(findById(groupId));
    }

    private Group findById(String groupId) {
