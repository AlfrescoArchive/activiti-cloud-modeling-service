...
public interface GroupJpaRepository extends JpaRepository<Group, String>,
    ...
    Optional<Group> findOneByNameAndParentIdIsNull(String name);
    @Override
    ...
    @Override
    default Optional<Group> findTopLevelGroupByName(String groupName) {
        return findOneByNameAndParentIdIsNull(groupName);
    }
